...
qb_depth_charts = depth_charts[depth_charts['position'] == 'QB']
print(qb_depth_charts)
...
weekdata = nfl.import_weekly_data(range(2017,2023))
te_depth_charts = depth_charts[depth_charts['position'] == 'TE']
print(te_depth_charts)
